...
[docs-stable-url]: https://manybodylab.github.io/MPSKitPeriodic.jl/stable

[docs-dev-img]: https://img.shields.io/badge/docs-dev-blue.svg
[docs-dev-url]: https://manybodylab.github.io/MPSKitPeriodic.jl/dev

[doi-img]: https://zenodo.org/badge/DOI/
[doi-url]: https://doi.org/

[downloads-img]: https://img.shields.io/badge/dynamic/json?url=http%3A%2F%2Fjuliapkgstats.com%2Fapi%2Fv1%2Ftotal_downloads%2FMPSKitPeriodic&query=total_requests&label=Downloads
[downloads-url]: http://juliapkgstats.com/pkg/MPSKitPeriodic

[ci-img]: https://github.com/ManyBodyLab/MPSKitPeriodic.jl/actions/workflows/Tests.yml/badge.svg
[ci-url]: https://github.com/ManyBodyLab/MPSKitPeriodic.jl/actions/workflows/Tests.yml

[pkgeval-img]: https://JuliaCI.github.io/NanosoldierReports/pkgeval_badges/M/MPSKitPeriodic.svg
[pkgeval-url]: https://JuliaCI.github.io/NanosoldierReports/pkgeval_badges/M/MPSKitPeriodic.html

[codecov-img]: https://codecov.io/gh/ManyBodyLab/MPSKitPeriodic.jl/branch/main/graph/badge.svg
[codecov-url]: https://codecov.io/gh/ManyBodyLab/MPSKitPeriodic.jl
...
```julia-repl
pkg> add git@github.com:ManyBodyLab/MPSKitPeriodic.jl.git
```
...
```julia
julia> using MPSKitPeriodic
```

## License

MPSKitPeriodic.jl is licensed under the [APL2 License](LICENSE). By using or interacting with this software in any way, you agree to the license of this software.
